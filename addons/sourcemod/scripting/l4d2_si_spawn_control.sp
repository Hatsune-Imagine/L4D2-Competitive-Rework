...
public void OnPluginStart()
{
	...
	g_cvSpawnTime =			CreateConVar("l4d2_si_spawn_control_spawn_time",			"20.0",	"SI spawn time.", FCVAR_NONE, true, 1.0);
	g_cvFirstSpawnTime =	CreateConVar("l4d2_si_spawn_control_first_spawn_time",		"20.0",	"SI first spawn time (after leaving the safe area).", FCVAR_NONE, true, 0.1);
	g_cvKillSITime =		CreateConVar("l4d2_si_spawn_control_kill_si_time",			"30.0",	"Auto kill SI time. if it 'slack off'.", FCVAR_NONE, true, 0.1);
	...
	g_cvTogetherSpawn =		CreateConVar("l4d2_si_spawn_control_together_spawn",		"1",	"After SI dies, wait for other SI to spawn together.", FCVAR_NONE, true, 0.0, true, 1.0);
