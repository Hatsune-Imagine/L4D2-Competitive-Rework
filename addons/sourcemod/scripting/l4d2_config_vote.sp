...
public void OnPluginStart()
{
	...
	g_cvPassMode = CreateConVar("l4d2_config_vote_passmode", "0", "Method of judging vote pass. 0=Vote Yes count > Vote No count. 1=Vote Yes count > Half of players count.");
