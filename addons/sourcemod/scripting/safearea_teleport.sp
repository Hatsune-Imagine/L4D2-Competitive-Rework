...
public void OnPluginStart() {
	...
	g_hSafeAreaSound =		CreateConVar("st_sound",		"1",	"Whether emit count down sound to all survivors (0=No, 1=Yes)", CVAR_FLAGS);
	...
	g_hSafeAreaSound.AddChangeHook(CvarChanged);
...
void GetCvars() {
	...
	g_iSafeAreaSound = g_hSafeAreaSound.IntValue;
